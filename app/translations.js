...
const translations = {
  ...
  en: {
    ...
    'itinerary-summary.bikeAndPublic-trolleybus-title': 'Take your bike with you on the trolleybus',
    ...
    'map-layer-stop-trolleybus': 'Trolleybus stops',
    ...
    'modes.to-trolleybus': 'trolleybus stop',
    ...
    'nearest-stops-trolleybus': 'trolleybus stops',
    ...
    'trolleybus-with-route-number': 'Trolleybus {routeNumber} {headSign}',
    'try-again': 'Try again',
  ...
  lv: {
    'about-service-feedback': 'Par pakalpojumu un atsauksmes',
    'about-these-pages': 'Par tīmekļa lapu',
    'about-this-service': 'Par pakalpojumu',
    access_with: 'pieeja ar',
    accessibility: 'Piekļūstamība',
    'accessibility-limited': 'Ratiņkrēslā',
    'accessibility-nolimit': 'Nav ierobežojumu',
    'accessibility-statement': 'Piekļūstamības paziņojums',
    'add-favourite-bikeStation-failed-heading': 'Velo nomas stacijas saglabāšana neizdevās',
    'add-favourite-place-failed-heading': 'Vietas saglabāšana neizdevās',
    'add-favourite-route-failed-heading': 'Maršruta saglabāšana neizdevās',
    'add-favourite-station-failed-heading': 'Stacijas saglabāšana neizdevās.',
    'add-favourite-stop-failed-heading': 'Pieturas saglabāšana neizdevās',
    'add-home': 'Iestatīt mājas',
    'add-itinerary-via-point': 'Pievienot maršruta starppunktu',
    'add-location-to-favourites': 'Pievienot vietu izlasei',
    'add-to-favourites': 'Pievienot izlasei',
    'add-via-button-label': 'Pievienot starppunktu',
    'add-via-duration-button-label': 'Iestatīt apstāšanās ilgumu {index}. starppunktā',
    'add-via-duration-button-label-close': 'Aizvērt apstāšanās ilguma izvēli {index}. starppunktā',
    'add-via-duration-button-label-open': 'Atvērt apstāšanās ilguma izvēli {index}. starppunktā',
    'add-work': 'Iestatīt darbavietu',
    all: 'Visi',
    'alternative-legs': 'Arī {leg1}. plkst. {startTime1} un {leg2}. plkst. {startTime2}',
    'alternative-legs-single': 'Arī {leg1} plkst. {startTime1}',
    'aria-itinerary-summary':
      'Kopējais ceļa ilgums {duration}. Atiet {inFuture} {departureTime} un pienāk {arrivalTime}',
    'aria-itinerary-summary-bike-distance':
      'Kopā ar velo {duration}, {distance} ',
    'aria-itinerary-summary-car-distance':
      'Kopā ar auto {duration}, {distance} ',
    'aria-itinerary-summary-walk-distance':
      'Kopā staigāt {duration}, {distance} ',
    'arrive-leave': 'Pienākt vai iziet noteiktā laikā',
    'as-destination': 'Galamērķis',
    'as-origin': 'Sākumpunkts',
    'as-viapoint': 'Starppunkts',
    'app': 'Mobilā lietotne',
    back: 'Atpakaļ',
    'buy-in-app': 'Pirkt lietotnē',
    'search-autosuggest-label': 'Vietu un pieturu meklētājs.',
    'search-autosuggest-label-instructions': 'Pārej sarakstā ar bultu taustiņiem, veic atlasi ar enter taustiņu.',
    'search-autosuggest-label-move-to-destination': 'Pēc sākumpunkta izvēles automātiski tiksiet pārvirzīts uz galamērķa ievadi.',
    'search-autosuggest-len': '{len, plural, =1 {Pieejams 1 ieteikums} other {Pieejami {len} ieteikumi}}',
    'search-current-suggestion': 'Pašreizējā izvēle: {selection}',
    'select-date': 'Izvēlieties datumu',
    'select-from-map-destination': 'Izvēlieties galamērķi',
    'select-from-map-favourite': 'Atlasiet kartē',
    'select-from-map-no-title': 'Nav virsraksta',
    'select-from-map-origin': 'Atlasiet sākumpunktu',
    'select-from-map-viaPoint': 'Atlasiet starppunktu',
    'set-time-earlier-button-label': 'Iestatiet agrāku brauciena laiku',
    'set-time-later-button-label': 'Iestatiet vēlāku brauciena laiku',
    'set-time-now-button-label': 'Iestatiet brauciena laiku tagad',
    'station-entrance': 'Ieeja',
    'station-exit': 'Izeja',
    'time-navigation-buttons': 'Laika navigācijas pogas',
    'time-selector-form': 'Rediģēt laiku',
    // eslint-disable-next-line sort-keys
    address: 'Adrese',
    'address-or-stop': 'Adrese vai pietura',
    agency: 'Pārvadātājs',
    airplane: 'Lidojums',
    'airplane-with-route-number': 'Lidojums {routeNumber}',
    'airport-check-in': 'Ierodoties reģistrējieties nekavējoties, ja neesat to izdarījuši iepriekš',
    'airport-collect-luggage': 'Savāciet savu bagāžu',
    'airport-security-check-go-to-gate': 'Dodieties uz saviem vārtiem caur drošības kontroli',
    'all-routes': 'Visi maršruti',
    'all-routes-disabled': 'Nav maršrutu',
    'arriving-at': 'Pienāk',
    'arriving-soon': 'Tagad',
    'at-time': 'plkst.',
    'avoid-transfers': 'Izvairīties no pārsēšanās',
    'avoid-walking': 'Izvairīties no staigāšanas',
    'back-button-title': 'Doties uz iepriekšējo lapu',
    'back-to-front-page': 'Atpakaļ uz sākumlapu',
    bicycle: 'Velo',
    'bicycle-distance-duration': 'Velo {duration} ({distance})',
    'bicycle-walk-from-transit':
      'Take your bike off the {transportMode} and walk it for {distance} ({duration})',
    'bicycle-walk-from-transit-no-duration':
      'Walk your bike off the {transportMode}',
    ...
    'bus-express': 'Trunk bus',
    'bus-express-with-route-number': 'Trunk bus {routeNumber} {headSign}',
    'bus-local': 'Vietējais autobuss',
    'bus-with-route-number': 'Autobuss {routeNumber} {headSign}',
    buy: 'Pirkt',
    'buy-ticket': 'Kā pirkt biļeti',
    call: 'Pieteikt transportu pēc pieprasījuma',
    'call-number': 'Zvanīt {number}',
    'call-with-route-number':
      'Pieteikt transportu pēc pieprasījuma {routeNumber} {headSign}',
    cancel: 'Atcelt',
    canceled: 'Atcelts',
    'canceled-itineraries-amount': 'Papildus {itineraryAmount, plural, =1 {1 atcelts maršruts} other {{itineraryAmount} atcelti maršruti}}',
    'canceled-itineraries-amount-hide':
      'Paslēpt atceltos maršrutus ({itineraryAmount})',
    'capacity-modal.crushed-standing-room-only-body':
      'Tikai dažas stāvvietas',
    'capacity-modal.crushed-standing-room-only-heading': 'Pārpildīts',
    'capacity-modal.few-seats-available-body': 'Dažas brīvas sēdvietas',
    'capacity-modal.few-seats-available-heading': 'Nav pārpildīts',
    'capacity-modal.full-capacity-body': 'Nav pieejamas sēdvietas vai stāvvietas',
    'capacity-modal.full-capacity-heading': 'Pilnīgi pilns',
    'capacity-modal.heading': 'Vai transportā ir vieta?',
    'capacity-modal.legend': 'Simbolu leģenda',
    'capacity-modal.many-seats-available-body': 'Daudz brīvu sēdvietu',
    'capacity-modal.many-seats-available-heading': 'Pustukšs',
    'capacity-modal.standing-room-only-body':
      'Pieejamas tikai stāvvietas vai dažas sēdvietas',
    'capacity-modal.standing-room-only-heading': 'Gandrīz pilns',
    'capacity-modal.subheading':
      'Reāllaika transporta piepildījuma informācija ir pieejama atsevišķiem transportlīdzekļiem',
    car: 'Auto',
    'car-distance-duration': 'Brauciens {duration} ({distance})',
    'car-distance-no-duration': 'Brauciens {distance}',
    'car-drive-from-transit-no-duration':
      'Brauciet ar savu auto no {transportMode}',
    'car-drive-to-transit-no-duration': 'Brauciet ar savu auto uz {transportMode}',
    'car-park': 'Park & ride',
    'car-park-disclaimer': 'You can conveniently combine car and public transport: leave your car at a Park & Ride and continue by train, bus, metro or tram. Car parking is free of charge and there are no time limits.',
    'car-park-disclaimer-header': 'Park your car',
    'car-park-disclaimer-link': 'Read more about Park & Ride',
    cause: 'Cēlonis',
    'char-left': 'rakstzīmes',
    'choose-freely': 'Pēc izvēles',
    'choose-stop': 'Izvēlieties pieturu',
    'choose-stop-or-vehicle': 'Izvēlieties pieturu vai transportu',
    'choose-vehicle': 'Izvēlieties transportlīdzekli',
    citybike: 'City bike',
    'citybike-distance-duration': 'Bike {duration} ({distance})',
    'citybike-duration-general-header':
      'Extra charge applies to several sections of route to be completed by a city bike.',
    ...
    'citybike-station': 'Bike station {stationId}',
    'citybike-station-no-id': 'Bike station',
    'clear-button-label': 'Notīrīt',
    close: 'Aizvērt',
    'close-favourite-module': 'Aizvērt izlases paneli',
    'close-settings': 'Aizvērt logu un saglabāt iestatījumus',
    continue: 'Turpināt',
    'cookie-settings': 'Sīkdatņu iestatījumi',
    'copy-code': 'Kopēt kodu',
    covered: 'Ar nojumi',
    'create-embedded-search': 'Izveidot maršruta meklēšanas elementu',
    'create-stop-monitor': 'Izveidot pieturas atiešanas laiku displeju',
    'crushed-standing-room-only': 'Pārpildīts, tikai dažas stāvvietas',
    'cycle-distance-duration': 'Velo {duration} ({distance})',
    'cyclewalk-distance-duration': 'Stumt velo {duration} ({distance})',
    currentposition: 'Pašreizējā atrašanās vieta',
    datasources: 'Datu avoti',
    date: 'Datums',
    day: 'Diena',
    delete: 'Dzēst',
    'delete-favourite-failed-heading': 'Nevarēja izdzēst no izlases',
    'departure-list-update.sr-instructions':
      'Atiešanas laiku saraksts tiks atjaunināts reāllaikā.',
    'departure-page-sr': 'Reisa {shortName} {destination} {time} informācija',
    'departure-time-in-minutes': '{minutes} min',
    'departure-time-sr': '{when} plkst. {time}. {realTime}',
    departures: 'Atiešanas laiki',
    'departures-by-hour': 'Atiešanas laiki pa stundām',
    'departures-by-hour-minutes-route': '(minūte/maršruts)',
    'departures-not-found':
      'Diemžēl izvēlētajai pieturai netika atrasti atiešanas laiki.',
    'departures-not-found-time-threshold':
      'Diemžēl izvēlētajai pieturai netika atrasti atiešanas laiki. Iespējams meklētais datums ir pārāk tālu nākotnē. Lūdzu mēģiniet vēlreiz tuvāk sava brauciena laikam.',
    description: 'Find public transport services to locations near and far.',
    destination: 'Galamērķis',
    'destination-defined': 'Galamērķis norādīts',
    'destination-outside-service': 'Maršruti netika atrasti, jo galamērķis ir ārpus apkalpotās teritorijas.',
    'destination-placeholder': 'Ievadi galamērķi, maršrutu vai pieturu',
    'dialog-return-to-map': 'Atgriezties uz karti',
    'digitransit-platform': 'Digitransit platforma',
    disclaimer: 'Lūdzu ņemiet vērā, ka rezultāti ir balstīti uz aprēķinātajiem pienākšanas un atiešanas laikiem. Ieteiktie savienojumi nevar tikt garantēti.',
    disruption: 'Brīdinājums',
    'disruption-info': 'Brīdinājuma informācija',
    'disruption-info-no-alerts': 'Nav brīdinājumu.',
    'disruption-info-route-no-alerts': 'Šim maršrutam nav brīdinājumu.',
    disruptions: 'Brīdinājumi',
    'disruptions-and-diversions': 'Brīdinājumi',
    'disruptions-tab.sr-disruptions': 'Viens vai vairāki brīdinājumi',
    'disruptions-tab.sr-no-disruptions': 'Nav brīdinājumu',
    'distance-between': 'Attālums {distance1} m — {distance2} m',
    'distance-total': 'Kopējais attālums',
    'distance-under': 'Attālums mazāks par {distance} m',
    'e-scooter': 'Electric scooter',
    'e-scooter-alternative':
      'How about using an electric scooter for part of your journey? {paymentInfo}',
    'e-scooter-disclaimer-close': 'Close scooter disclaimer',
    ...
    'e-scooters-available':
      'There are electric scooters available in the area. Use an app to unlock the electric scooter.',
    earlier: 'Agrāki atiešanas laiki',
    'edit-favourites': 'Rediģē vietu izlasē',
    'elevation-gained-total': 'Kopējais kāpums',
    'elevation-lost-total': 'Kopējais kritums',
    'embedded-search.choose-language': 'Valoda',
    'embedded-search.choose-mode': 'Transporta veidi',
    'embedded-search.choose-width-component': 'Iegultā elementa platums',
    'embedded-search.form-heading': 'Iegulšanas rīki',
    engine_ignition_aid: 'Engine starting aid',
    english: 'Angliski',
    explanations: 'Paskaidrojumi',
    'extra-info': 'Papildus informācija',
    'favourite-failed-text': 'Lūdzu mēģiniet vēlreiz pēc brīža!',
    'favourite-target': 'Izlases vieta',
    ferry: 'Prāmis',
    'ferry-external': 'Prāmis',
    'ferry-external-with-route-number': 'Prāmis {routeNumber} {headSign}',
    'ferry-with-route-number': 'Prāmis {routeNumber} {headSign}',
    'few-seats-available': 'Dažas brīvas sēdvietas',
    finnish: 'Somiski',
    'free-of-charge': 'Bezmaksas',
    'from-bus': 'autobusa',
    'from-ferry': 'prāmja',
    'from-ferrypier': 'prāmju piestātnes',
    'from-rail': 'vilciena',
    'from-scooter-location': 'skrejriteņa atrašanās vietas',
    'from-station': 'stacijas',
    'from-stop': 'pieturas',
    'from-subway': 'metro',
    'from-tram': 'tramvaja',
    frontpage: 'Sākumlapa',
    full: 'Pilns',
    funicular: 'Funikulieris',
    'generic-cancelation': '{mode} {route} {headsign} plkst. {time} ir atcelts.',
    'generic-error': 'Notika kļūda',
    'geolocate-yourself': 'Noteikt Jūsu atrašanās vietu',
    'geolocation-denied-heading': 'Ģeolokācija noraidīta',
    'geolocation-denied-text': 'Jūs neesat devuši piekļuvi atrašanās vietai. Jūs varat to sniegt tālruņa vai pārlūka iestatījumos.',
    'geolocation-failed-heading': 'Ģeolokācija neizdevās',
    'geolocation-failed-text': 'Jūsu pārlūks neatbalsta ģeolokācijas iegūšanu.',
    'geolocation-prompt-text': "Pieņemiet pārlūka ģeolokācijas pieprasījumu!",
    'geolocation-timeout-heading': 'Jūsu atrašanās vietas noteikšana prasa ilgāku laiku nekā paredzēts.',
    'geolocation-timeout-text': "Vai esat piekrituši pārlūka pieprasījumam piekļūt Jūsu atrašanās vietai?",
    'get-off-the-ride': 'TO_DO_Nouse pois kyydistä',
    'give-destination': 'Ievadiet galamērķi',
    'give-name-to-location': 'Dodiet šai vietai aprakstošu nosaukumu',
    'give-origin': 'Ievadiet sākumpunktu',
    'give-position': 'Enter your location or origin in the search field',
    'give-route': 'Meklējiet maršrutu',
    hour: 'Stunda',
    'hour-short': 'h',
    'how-to-rate-service': 'Kā Jūs vērtētu pakalpojumu?',
    hsl_mobile_ticket: 'HSL mobile ticket',
    hsl_ticket: 'HSL ticket',
    hsl_travel_card: 'HSL card',
    'in-addition': 'Papildus',
    'include-estonia': 'Iekļaut Igauniju',
    'index.title': 'Maršrutu plānotājs',
    inquiry: 'How did you find the new Journey Planner? Please tell us!',
    instructions: 'Instrukcijas',
    'is-open': 'Open:',
    'itinerary-co2.description':
      '{co2value} g CO₂ emisiju šajā maršrutā. Auto radītu {carCo2Value} g CO₂ emisiju šajā pašā maršrutā.',
    'itinerary-co2.description-simple':
      '{co2value} g CO₂ emisiju šajā maršrutā.',
    'itinerary-co2.description-simple-sr':
      '{co2value} g oglekļa dioksīda emisiju šajā maršrutā.',
    'itinerary-co2.description-sr':
      '{co2value} g oglekļa dioksīda emisiju šajā maršrutā. Auto radītu {carCo2Value} g of oglekļa dioksīdu emisiju šajā pašā maršrutā.',
    'itinerary-co2.link': 'Šis ir kā mēs samazinām emisijas ›',
    'itinerary-co2.title': 'Maršruta CO₂ emisijas',
    'itinerary-co2.title-sr': 'Maršruta oglekļa dioksīda emisijas',
    'itinerary-details.biking-leg':
      '{time} brauciet {distance} no {origin} uz {to} {destination}. Aprēķinātais ilgums {duration}',
    'itinerary-details.car-leg':
      '{time} brauciet {distance} no {origin} uz {to} {destination}. Aprēķinātais ilgums {duration}',
    'itinerary-details.end-leg':
      '{time} ierodies galamērķī {destination}.',
    'itinerary-details.route-has-info-alert': 'Maršrutam nav brīdinājumu.',
    'itinerary-details.route-has-severe-alert': 'Maršrutam ir svarīgs brīdinājums.',
    'itinerary-details.route-has-unknown-alert': 'Maršrutam ir brīdinājums.',
    'itinerary-details.route-has-warning-alert': 'Maršrutam ir brīdinājums.',
    'itinerary-details.scooter-leg':
      '{time} brauciet ar skrejriteni {distance} no {origin} uz {destination}. Aprēķinātais ilgums {duration}',
    'itinerary-details.transit-leg-part-1': '{time} {realtime} brauciet ar',
    'itinerary-details.transit-leg-part-2':
      'no pieturas {startStop} {startZoneInfo} {trackInfo} uz pieturu {endStop} {endZoneInfo}. Aprēķinātais ilgums {duration}',
    'itinerary-details.via-leg':
      '{arrivalTime} ierodieties starppunktā {viaPoint}. {leaveAction}',
    'itinerary-details.walk-leg':
      '{time} ejiet {distance} no {origin} uz {to} {destination}. Aprēķinātais ilgums {duration}',
    'itinerary-feedback-button': 'Sūtīt atsauksmes',
    'itinerary-feedback-message': "Neatradāt, ko meklējāt?",
    'itinerary-feedback-placeholder': 'Apraksts (neobligāti)',
    'itinerary-hide-alternative-legs': 'Paslēpt alternatīvas',
    'itinerary-hide-stops': 'Paslēpt pieturas',
    'itinerary-in-the-past': 'Maršruta meklēšanas periods iekrīt pagātnē.',
    'itinerary-in-the-past-link': 'Izbraukt tagad ›',
    'itinerary-in-the-past-title': 'Maršrutu varianti nevar tikt parādīti',
    'itinerary-page.description': 'Maršruts',
    'itinerary-page.hide-details': 'Paslēpt maršruta detaļas',
    'itinerary-page.itineraries-loaded': 'Meklēšanas rezultāti ielādēti',
    'itinerary-page.itineraries-updated': 'Meklēšanas rezultāti atjaunināti',
    'itinerary-page.loading-itineraries': 'Ielādē meklēšanas rezultātus',
    'itinerary-page.show-details': 'Parādīt maršruta detaļas',
    'itinerary-page.show-details-label': 'Parādīt maršruta {number} detaļas',
    'itinerary-page.title': 'Maršruts',
    'itinerary-page.update-alert': 'Meklēšanas rezultāti atjaunināti',
    'itinerary-summary-page-street-mode.update-alert': 'Iešanas un velo rezultāti atjaunināti',
    'itinerary-summary-page.description': 'Maršrutu ieteikumi',
    'itinerary-summary-page.title': 'Maršrutu ieteikumi',
    'itinerary-summary-row.biking-distance': 'Kopējais attālums ar velo {totalDistance}.',
    'itinerary-summary-row.clickable-area-description': 'Parādīt kartē',
    'itinerary-summary-row.description':
      'Maršruts atiet {departureDate} {departureTime} un ierodas {arrivalDate} {arrivalTime}. {firstDeparture} {transfers} Kopējais ilgums {totalTime}.',
    'itinerary-summary-row.first-departure':
      '{vehicle} atiet {departureTime} no pieturas {stopName}.',
    'itinerary-summary-row.first-leg-start-time':
      'Atiet {firstDepartureTime} no {firstDepartureStopType} {firstDepartureStop}{firstDeparturePlatform}',
    'itinerary-summary-row.first-leg-start-time-citybike':
      'Jāizbrauc {firstDepartureTime} no {firstDepartureStop} velo nomas stacijas',
    'itinerary-summary-row.first-leg-start-time-scooter':
      'Jāizbrauc {firstDepartureTime} ar skrejriteni',
    'itinerary-summary-row.no-transit-legs': 'Izej, kad ērtāk',
    'itinerary-summary-row.transfers':
      'Pārsēdies uz {vehicle} pieturā {stopName}',
    'itinerary-summary-row.transfers-to-rental': 'Pārsēdies uz {vehicle}',
    'itinerary-summary-row.walking-distance':
      'Kopējais iešanas attālums {totalDistance}.',
    'itinerary-summary.bike-boarding-information':
      'Jums ir atļauts ņemt velo līdzi transportlīdzeklī. Lai uzzinātu tā pārvadāšanas maksu, vērsieties pie pārvadātāja!',
    'itinerary-summary.bikeAndPublic-bus-title':
      'Ņemiet savu velo līdzi autobusā',
    'itinerary-summary.bikeAndPublic-ferry-title':
      'Ņemiet savu velo līdzi uz prāmja',
    'itinerary-summary.bikeAndPublic-rail-title':
      'Ņemiet savu velo līdzi vilcienā',
    'itinerary-summary.bikeAndPublic-subway-title': 'Ņemiet savu velo līdzi metro',
    'itinerary-summary.bikeAndPublic-tram-title': 'Ņemiet savu velo līdzi tramvajā',
    'itinerary-summary.bikeAndPublic-trolleybus-title': 'Ņemiet savu velo līdzi trolejbusā',
    'itinerary-summary.bikePark-title': 'Leave your bike at a Park & Ride',
    'itinerary-summary.car-boarding-information':
      'You can take your car on board. Check with the transport operator if an additional fee will be charged for the transportation of cars.',
    'itinerary-summary.carAndPublic-ferry-title': 'Drive your car to the ferry',
    'itinerary-summary.carAndPublic-rail-title': 'Drive your car to the train',
    'itinerary-summary.interline-wait':
      'Maršruta numurs ({shortName}) un galamērķis ({destination}) mainīsies {stop} pieturā. Gaidīšanas laiks pieturā ir {time}. Lūdzu palieciet transportā!',
    'itinerary-summary.interline-wait-multiple-legs':
      'Maršruta numurs ({shortName}) un galamērķis mainīsies vairākas reizes ceļa laikā. Kopējais gaidīšanas laiks ir {time}. Lūdzu neizkāpiet no transporta!',
    'itinerary-summary.show-on-map': 'Parādīt kartē {target}',
    'itinerary-ticket.title': 'Nepieciešama biļete',
    'itinerary-tickets.title': 'Nepieciešamas biļetes',
    'itinerary-time.title': 'Ilgums',
    'itinerary-walk.title': 'Kopējais iešanas attālums',
    'journey-planner-manual': 'Maršrutu plānotāja rokasgrāmata',
    'journeyplanner.title': 'Maršrutu plānotājs',
    'language-selection': 'Valoda: {language}',
    later: 'Vēlāki atiešanas laiki',
    'leave-your-car-park-and-ride': 'Atstājiet savu auto Park & Ride',
    leaves: 'Atiet',
    'leaving-at': 'Atiet',
    ...
    loading: 'Ielādē...',
    localadmin: 'Apkaime',
    locate: 'Noteikt atrašanās vietu',
    'location-examples': 'piem., mājas, darbs, skola,...',
    'location-from-map': 'Atlasītā atrašanās vieta',
    'location-from-map-confirm': 'Apstiprināt izvēli',
    'location-home': 'Mājas',
    'location-school': 'Darbs',
    'location-shopping': 'Veikali',
    'location-sport': 'Sports',
    'location-work': 'Darbs',
    login: 'Pieslēgties',
    'login-content':
    ...
    'stop-list-update.sr-instructions':
      'Departure times for each stop will update in real time.',
    'stop-near-you': 'Meklēt tuvumā esošās pieturas vai maršrutus',
    'stop-near-you-modal-grant-permission': 'or enable location services',
    'stop-near-you-modal-grant-permission-info':
      'You can enable location services in your phone or browser settings, allowing the service to use your current location.',
    'stop-near-you-modal-header': 'You have not enabled location services',
    'stop-near-you-modal-info':
      'Using the nearby stops function requires location access.',
    'stop-near-you-title': 'Meklēt pieturas vai maršrutus',
    'stop-near-you-update-alert': 'Nearest stops updated',
    'stop-number': 'Stop number',
    'stop-page.description': 'Stop {name} - {code}',
    'stop-page.right-now.loaded': 'stop page loaded',
